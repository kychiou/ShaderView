...
internal class GLQuadMultiRenderImpl : GLQuadMultiRender {
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shaders.forEachIndexed { index, shader ->
            ...
            setAttribute(shader, VERTEX_SHADER_IN_POSITION, 3, TRIANGLE_VERTICES_DATA_POS_OFFSET, bufferToUse)
            setAttribute(shader, VERTEX_SHADER_IN_TEXTURE_COORD, 2, TRIANGLE_VERTICES_DATA_UV_OFFSET, bufferToUse)
     ...
     */
    private fun setAttribute(shader: GLShader, attrName: String, size: Int, offset: Int, buffer: FloatBuffer) {
        val attrLocation = glGetAttribLocation(shader, attrName)
